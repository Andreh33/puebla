...
const alertVariants = cva(
  "relative w-full rounded-xl border p-4 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg~*]:pl-7",
  {
    variants: {
      variant: {
        default: "border-zs-border bg-white text-zs-ink",
        info: "border-zs-blue-200 bg-zs-blue-50 text-zs-blue-900",
        success: "border-emerald-300 bg-emerald-50 text-emerald-900",
        warning: "border-amber-300 bg-amber-50 text-amber-900",
        destructive: "border-zs-red-200 bg-zs-red-50 text-zs-red-700",
      },
    },
